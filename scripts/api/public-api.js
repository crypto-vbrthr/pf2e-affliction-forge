...
export function createPublicApi() {
  ...
  return Object.freeze({
    ...
    catalogs: Object.freeze({
      ...
      reactionControllerActions: () => [...REACTION_CONTROLLER_ACTIONS],
      stageExpiryActions: () => [...STAGE_EXPIRY_ACTIONS],
    ...
    instances: Object.freeze({
      ...
      executePeriodic: (controllerOrUuid, periodicId, options = {}) => instanceService.executePeriodic(controllerOrUuid, periodicId, options),
    ...
    reactions: Object.freeze({
      ...
      inspectInitiative: (combatant, changes = {}, options = {}) => inspectFoundryInitiativeReactionEvent(combatant, changes, options),
      inspectTurnStart: (combat, options = {}) => inspectFoundryTurnStartReactionEvent(combat, options),
